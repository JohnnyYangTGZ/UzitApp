...
export default function AddShiftModal({ isOpen, onClose, onSuccess }) {
  ...
  }, [isOpen, selectedDepartmentId, selectedClinicId]);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.userId || !formData.date || !formData.startTime || !formData.endTime || !formData.clinicId) return;
